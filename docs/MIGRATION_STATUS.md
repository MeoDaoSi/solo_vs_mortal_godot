...
| 2 — Simulation and application | IN PROGRESS | Typed event bus plus Player, Monster and Combat runtime owners are connected through headless `GameSession`; Application exposes commands and immutable snapshots only | Add Phase 2 parity checks, then port Progression, Soul, Banner, Summon and advanced Soul systems |
