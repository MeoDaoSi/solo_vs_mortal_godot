...
| 2 — Simulation and application | IN PROGRESS | Player/Monster/Combat runtime owners, typed events, Progression inventory/buffs, isolated Player modifier sources, and Application snapshots/commands are implemented; expanded parity harness compiles | Run Phase 2 parity scenarios, then port Soul and Soul Banner ownership |
