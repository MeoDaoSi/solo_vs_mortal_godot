...
public static class GameSaveCodec
{
    ...
    private static WorldSaveData? World(JsonElement root) => root.TryGetProperty("world", out var value) && value.ValueKind == JsonValueKind.Object ? new(Strings(value, "destroyedObjectIds"), Text(value, "currentRegionId")) : null;
