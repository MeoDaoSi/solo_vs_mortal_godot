...
public sealed partial class GameSession
{
    ...
    public IReadOnlyList<V25TerrainArea> CanonicalTerrain => CanonicalContent is null ? Array.Empty<V25TerrainArea>() :
        V25WorldLayout.Terrain(CanonicalContent.Content.Regions.First(r => r.Id == CanonicalRegionId), CanonicalContent);
